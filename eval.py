from src.data import COCODetection, get_label_map, COLORS
from yolact import Yolact
from src.yolact.utils.ms_augmentations import BaseTransform, FastBaseTransform
from src.yolact.utils.functions import MovingAverage, ProgressBar
from src.yolact.layers import jaccard, mask_iou
from src.yolact.utils import timer
from src.yolact.utils.functions import SavePath
from src.yolact.layers.utils.output_utils import postprocess, undo_image_transformation
import pycocotools

from src.data import cfg, set_cfg, set_dataset
        ...
        for it, image_idx in enumerate(dataset_indices):
            ...
            with timer.env('Load Data'):
                ...
                if cfg.mask_proto_debug:
                    with open('src/yolact/scripts/info.txt', 'w') as f:
